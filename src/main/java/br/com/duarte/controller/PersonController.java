...
public class PersonController {
	...
	@PutMapping(consumes = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
			MediaType.APPLICATION_YML }, produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YML })
	@Operation(summary = "Updates a Person ", description = "Update a Person by passing in a Json, XML or YML representation of the person", tags = {
			"People" }, responses = {
					@ApiResponse(description = "Updates", responseCode = "200", content = @Content(schema = @Schema(implementation = PersonVO.class))),
	...
	@Operation(summary ="Deletes a new Person ", description = "Deletes a new Person by passing in a Json, XML or YML representation of the person", tags = {"People"},
	responses = {
